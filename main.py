...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="🧚 GRUPLARA EKLE!", url="https://t.me/MajesteGameBot?startgroup=a")
        ...
        admin = InlineKeyboardButton(text="👨🏻‍💻 Müzik botu", url="https://t.me/MajesteMusicRoBot")

        keyboard = [[addme],[sohbet],[oyun],[admin]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        update.message.reply_text('ÖZEL SOHBETTE OYUN OYNANMIYOR!\n'+
                                  'Merhaba! Botumuz @MajesteGameBot oyunun telegrama uyarlanmış hali.Gruba ekleyip yetki verdikten sonra geriye oynamak kalıyor 😉 destek için @MajesteSahip.Komutlar için /help yazınız!\n' +
